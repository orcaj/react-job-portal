...
import { H4, LinkButtonMod, Button, FormWrapper, FormLabel } from 'components';
      ...
      <PaymentPageWrapper>
        <FormWrapper>
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex align-items-center flex-wrap justify-content-between justify-content-md-start mt-4">
              <Button
